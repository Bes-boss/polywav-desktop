...
// Dual-mode: node:test requires it, and the renderer loads it with a script
// tag because contextIsolation means there is no require() in app.js.
if (typeof module !== 'undefined' && module.exports) {
  module.exports = API;
} else if (typeof window !== 'undefined') {
  window.PolywavNaming = API;
}
